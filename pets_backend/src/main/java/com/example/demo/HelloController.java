package com.example.petsbackend;
...
@RestController
@Tag(name = "Hello Controller", description = "Basic endpoints for petsbackend")
public class HelloController {
    
    @GetMapping("/")
    @Operation(summary = "Welcome endpoint", description = "Returns a welcome message")
    public String hello() {
        return "Hello, Spring Boot! Welcome to petsbackend";
    }
    ...
    public String info() {
        return "Spring Boot Application: petsbackend";
    }
} 